...
public class GroupViewFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        expGroupListView = view.findViewById(R.id.grpExp);
        ...
        listAdapter = new ExpandableListAdapter(container.getContext(), listGroupHeader, listGroupChildOption);
                    ...
                    public void processFinish(String result) {
                        try {
                            ...
                            if(childPosition==0){
                                ...
                                Intent intent = new Intent(getActivity(), GroupViewMapsActivity.class);
